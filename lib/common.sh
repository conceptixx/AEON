...
EOF
    ...
    echo -e "${BOLD}${CYAN}${BOX_V}  Version: $AEON_VERSION$(printf '%*s' $((60 - 11 - ${#AEON_VERSION})) '')${BOX_V}${NC}"
    echo -e "${BOLD}${CYAN}${BOX_V}  Installation Directory: $AEON_DIR$(printf '%*s' $((60 - 26 - ${#AEON_DIR})) '')${BOX_V}${NC}"
